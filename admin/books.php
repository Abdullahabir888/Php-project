  ...
  document.body.style.backgroundColor = "skyblue";
	...
	<div class="srch">
		<form class="navbar-form" method="post" name="form1">
				...
				<button style="background-color: #96df26; border-radius: 20px;" type="submit" name="submit" class="btn btn-default">
	...
	<div class="srch">
		<form class="navbar-form" method="post" name="form1">
				...
				<button style="background-color: #ef629f;" type="submit" name="submit1" class="btn btn-default">Request
				</button>
		</form>
	</div>
