...
<section>
    <div class="gut_img">
        ...
        <h1 style="text-align: center; font-size: 25px;font-family: 'Times New Roman', Times, serif;">Amin Login</h1><br>
      <form name="login" action="" method="POST">
          <br>
          <div class="login">
          <input type="text" name="Username" placeholder="Username" required=""> <br><br>
          <input type="password" name="Password"  placeholder="Password" required> <br><br>
          <input class="btn btn-default" type="submit" name="submit" value="Login" style="color: #bf0fff; width: 70px; height: 40px"> 
